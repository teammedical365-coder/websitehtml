...
export const metadata = {
  title: 'Queue & Token Management - Medical365',
  description: 'Reduce waiting room chaos with Medical365 Smart Queue System. Multi-counter token management, WhatsApp alerts, and digital display boards for hospitals and clinics.',
};
  ...
  return (
    <>
      <section className="page-hero">
        <div className="hero-inner">
          <div className="hero-text">
            <div className="badge reveal">🎫 Smart Queue System</div>
            <h1 className="reveal" style={{ animationDelay: '0.1s' }}>
              End the <span className="text-gradient">Waiting Room Chaos</span>
            </h1>
            <p className="reveal" style={{ animationDelay: '0.2s' }}>
              Medical365 intelligent queue management system reduces perceived wait times, improves patient flow, and keeps your front desk calm — even on the busiest days.
            </p>
          ...
          <div className="hero-visual reveal" style={{ animationDelay: '0.3s' }}>
            <div className="hero-card">
              ...
              <div className="metric-row" style={{ display: 'flex', gap: '15px', margin: '20px 0' }}>
                ...
                <div className="metric">
                  <div className="metric-val" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>320</div>
                  <div className="metric-lbl" style={{ fontSize: '0.8rem', opacity: 0.6 }}>Tokens Today</div>
                </div>
                <div className="metric">
                  <div className="metric-val" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>97%</div>
                  <div className="metric-lbl" style={{ fontSize: '0.8rem', opacity: 0.6 }}>On-Time</div>
                </div>
              </div>
              {[
                { label: "OPD Queue", value: "72%" },
                { label: "Lab Queue", value: "45%" },
                { label: "Pharmacy Queue", value: "38%" }
              ].map((prog, i) => (
      ...
      <section className="features-section" style={{ padding: '100px 0' }}>
        <div className="container">
          <div className="section-header reveal" style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <p style={{ opacity: 0.7, maxWidth: '600px', margin: '0 auto' }}>Intelligent patient routing for a stress-free environment.</p>
          </div>
          <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
            {[
              { 
                ...
                title: "Multi-Counter System", 
                desc: "Auto-assign tokens for OPD, Lab, Pharmacy, and Billing. Manage multiple counters from one consolidated board." 
              },
              { 
                icon: <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>, 
                title: "WhatsApp Alerts", 
                desc: "Patients get queue status and 'your turn' alerts on their phone, reducing waiting room crowding by up to 50%." 
              },
              { 
                icon: <rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect>, 
                title: "Digital Display Boards", 
                desc: "Cloud-based display for lobby TVs showing token numbers and estimated wait times for each department." 
              },
              { 
                icon: <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>, 
                title: "Priority Bypass", 
                desc: "Fairly manage emergencies and priority patients (elderly, pregnant) with a simple one-click bypass system." 
              },
              { 
                icon: <circle cx="12" cy="12" r="10"></circle>, 
                title: "Real-Time Analytics", 
                desc: "Monitor live wait times, peak hours, and staff service speed to optimize your facility's patient flow." 
              },
              { 
                icon: <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>, 
                title: "Self Check-in Kiosk", 
                desc: "Integrate with touch-screen hardware for self-service token generation and contact verification." 
              }
            ].map((feat, i) => (
        ...
        <div className="container">
          <div className="benefits-inner" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            <div className="reveal">
              <h2 style={{ fontSize: '2.5rem', marginBottom: '25px' }}>Happy Patients, Calmer Staff</h2>
              <p style={{ fontSize: '1.1rem', opacity: 0.8, marginBottom: '30px' }}>
                Overcrowded waiting rooms drive patients away. A smooth, transparent queue experience improves your facility's reputation and staff morale.
              </p>
              <ul className="check-list" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '40px' }}>
                {[
                  "50% less room crowding",
                  "Wait from anywhere local",
                  "Zero specialty hardware",
                  "Browser-based TV sync",
                  "Multi-dept support",
            ...
            <div className="benefits-visual reveal" style={{ padding: '40px', background: 'rgba(255,255,255,0.03)', borderRadius: '30px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <div style={{ fontSize: '1.1rem', fontWeight: 'bold', marginBottom: '25px' }}>📊 Impact Dashboard</div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '40px' }}>
                  <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '2rem', fontWeight: 'bold', color: 'var(--primary)' }}>50%</div>
                      <div style={{ fontSize: '0.8rem', opacity: 0.6 }}>Crowding Drop</div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '2rem', fontWeight: 'bold', color: 'var(--primary)' }}>8m</div>
                      <div style={{ fontSize: '0.8rem', opacity: 0.6 }}>Wait Reduction</div>
                  </div>
              </div>
              {[
                  { label: "Patient Satisfaction", val: "92%" },
                  { label: "Staff Stress Reduction", val: "70%" },
                  { label: "No-Show Prevention", val: "38%" }
              ].map((stat, i) => (
      ...
      <section className="workflow-section" style={{ padding: '100px 0' }}>
        <div className="container">
          <div className="section-header reveal" style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Patient Flow</h2>
            <p style={{ opacity: 0.7 }}>A seamless 5-step journey for every visit.</p>
          </div>
          <div className="workflow-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '20px' }}>
            {[
              { step: 1, title: "Arrive", desc: "Check-in at desk/kiosk" },
              { step: 2, title: "Token", desc: "Smart ID auto-assigned" },
              { step: 3, title: "Wait", desc: "WhatsApp status updates" },
              { step: 4, title: "Called", desc: "Display board notification" },
              { step: 5, title: "Served", desc: "Service logged & complete" }
            ].map((wf, i) => (
      ...
      <section className="integrations-section" style={{ padding: '100px 0', textAlign: 'center' }}>
          <div className="container">
              ...
              <div className="reveal" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '15px' }}>
                  {[
                      "WhatsApp API", "SMS Gateway", "OPD Calendar", "Digital Signage", 
                      "Self-service Kiosks", "Reception Tablet", "Pharmacy Counter", "Lab Status"
                  ].map((chip, i) => (
                      <span key={i} style={{ 
                          padding: '10px 25px', 
      ...
      <section className="bottom-cta" style={{ padding: '100px 0', textAlign: 'center', background: 'linear-gradient(135deg, rgba(55, 179, 156, 0.1) 0%, rgba(30, 41, 59, 0.5) 100%)' }}>
        <div className="container">
          <h2 className="reveal" style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Transform your patient flow.</h2>
          <p className="reveal" style={{ opacity: 0.8, marginBottom: '40px' }}>See the Medical365 queue system in action with a live demo.</p>
