module.exports = [
  {
    ...
    "faqs": [
      {
        "q": "Is telemedicine legal in India?",
        "a": "Yes, telemedicine is fully legal in India and governed by the Telemedicine Practice Guidelines issued by the MoHFW."
      },
      {
        "q": "Can I prescribe via telemedicine?",
        "a": "Yes, registered medical practitioners can prescribe medications via telemedicine, subject to the restrictions outlined in the official guidelines."
      },
      {
        "q": "How does Medical365 handle telemedicine billing?",
        "a": "Medical365 integrates direct payment gateways, requiring patients to prepay for their online slots, which automatically generates the invoice in the hospital billing system."
      }
    ],
  ...
  },
  {
    ...
    "faqs": [
      {
        "q": "Is DPDP Act applicable to small clinics?",
        "a": "Yes, the DPDP Act applies to all entities processing digital personal data, regardless of the size of the clinic."
      },
      {
        "q": "What patient data does DPDP cover?",
        "a": "It covers all digitized personal data, including names, contact details, medical history, diagnostic reports, and payment information."
      },
      {
        "q": "How does Medical365 handle DPDP compliance?",
        "a": "Medical365 utilizes 256-bit encryption, India-based servers, role-based access controls, and integrated consent management to ensure DPDP compliance."
      }
    ],
  ...
  },
  {
    ...
    "faqs": [
      {
        "q": "What is the best dental software in India?",
        "a": "Medical365 is widely regarded as one of the best due to its robust interactive tooth charting, imaging integration, and ABDM compliance."
      },
      {
        "q": "Does dental software support ABDM?",
        "a": "Modern platforms like Medical365 fully support ABDM, allowing dentists to link treatments to a patient's ABHA ID."
      },
      {
        "q": "Can I manage multiple dental chairs with Medical365?",
        "a": "Yes, Medical365 supports multi-chair and multi-doctor scheduling seamlessly."
      }
    ],
  ...
  },
  {
    ...
    "faqs": [
      {
        "q": "How does queue management reduce wait times?",
        "a": "By optimizing patient flow, interleaving walk-ins with appointments, and providing real-time analytics to adjust staffing during peak hours."
      },
      {
        "q": "Can patients check their token status on WhatsApp?",
        "a": "Yes, systems like Medical365 send live token updates directly to the patient's WhatsApp."
      },
      {
        "q": "Does Medical365 queue system work offline?",
        "a": "Medical365 utilizes an offline-first architecture, ensuring that the token generation and queue progression continue to function smoothly even during internet drops."
      }
    ],
  ...
  },
  {
    ...
    "faqs": [
      {
        "q": "Can pharmacy software integrate with the EMR?",
        "a": "Yes, an integrated HMS like Medical365 pushes e-prescriptions directly from the EMR to the pharmacy dispensing queue."
      },
      {
        "q": "How does Medical365 handle medicine expiry alerts?",
        "a": "It uses strict batch tracking to enforce FEFO dispensing and provides automated dashboard alerts for items nearing their expiry dates."
      },
      {
        "q": "Does it support multiple pharmacy stores?",
        "a": "Yes, Medical365 handles stock transfers and indents between the central medical store and various sub-stores or wards."
      }
    ],
