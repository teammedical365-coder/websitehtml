...
with open("scratch/batch2_all_data.json", "r", encoding="utf-8") as f:
    batch2 = json.load(f)

# 9. pediatric-dosage-calculator
batch2["pediatric-dosage-calculator"] = {
    "cluster": "PEDIATRICS",
...
batch2["developmental-milestones"] = {
    "cluster": "PEDIATRICS",
...
# 13. vision-refraction-charts
batch2["vision-refraction-charts"] = {
...
# 14. retina-imaging-integration
batch2["retina-imaging-integration"] = {
    "cluster": "OPHTHALMOLOGY",
...
# 15. eye-pressure-tracking
batch2["eye-pressure-tracking"] = {
    "cluster": "OPHTHALMOLOGY",
...
# 16. optical-prescription-mgt
batch2["optical-prescription-mgt"] = {
    "cluster": "OPHTHALMOLOGY",
...
# 17. lasik-surgery-records
batch2["lasik-surgery-records"] = {
    "cluster": "OPHTHALMOLOGY",
...
# Save updated batch2 to JSON
with open("scratch/batch2_all_data.json", "w", encoding="utf-8") as f:
    json.dump(batch2, f, indent=2)

print(f"=== BATCH 2 DATA PREPARATION COMPLETE: Total {len(batch2)} pages ready in scratch/batch2_all_data.json ===")
