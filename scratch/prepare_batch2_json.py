...
print("=== PREPARING BATCH 2 DATA (17 PAGES) ===")
...
# Add remaining 14 pages of Batch 2:
# 4. cognitive-assessment
batch2["cognitive-assessment"] = {
    "cluster": "NEUROLOGY",
...
# 6. neurological-exam-forms
batch2["neurological-exam-forms"] = {
    "cluster": "NEUROLOGY",
...
# Save batch2 to JSON file
with open("scratch/batch2_all_data.json", "w", encoding="utf-8") as f:
    json.dump(batch2, f, indent=2)

print(f"Generated {len(batch2)} pages in scratch/batch2_all_data.json")
