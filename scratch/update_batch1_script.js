...
const scriptPath = path.join(repoRoot, 'scratch/generate_batch1_cardio_ortho.js');
let scriptContent = fs.readFileSync(scriptPath, 'utf8');

const remaining4Orthopedics = `
    // 11. JOINT MOBILITY TRACKING
...
// Insert remaining 4 into batch1Data definition
scriptContent = scriptContent.replace('// Merge Batch 1 data', remaining4Orthopedics + '\n// Merge Batch 1 data');
fs.writeFileSync(scriptPath, scriptContent, 'utf8');
console.log('Updated scratch/generate_batch1_cardio_ortho.js with all 14 pages!');
